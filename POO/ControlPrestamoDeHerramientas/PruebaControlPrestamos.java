   ...
   public class PruebaControlPrestamos {
         ...
         do{
            ...
            switch(opc) {
               case 1: 
                  ...
                  break;
               case 2: 
                  consultaIndividualTrabajador(cp);
                  break;
               case 3: 
                  consultaGeneralTrabajador(cp);
                  break;
               case 4: 
                  break;
               default:
         ...
         do{
            ...
            switch(opc) {
               case 1: 
                  ...
                  break;
               case 2: 
                  consultaIndividualHerramienta(cp);
                  break;
               case 3: 
                  consultaGeneralHerramienta(cp);
                  break;
               case 4: 
                  break;
               default:
         ...
         do{
            ...
            switch(opc) {
               ...
               case 2: 
                  ...
                  break;
               case 3: 
                  consultaIndividualPrestamo(cp);
                  break;
               case 4: 
                  reportePrestamosActivos(cp);
                  break;
               case 5:
                  reportePrestamosConcluidos(cp);
               default:
                  System.out.println("\n(!) Opción no valida");
                  break;
      ...
      private static void altaTrabajador(ControlPrestamos cp) {
         int id, celda;
      ...
      private static void altaHerramienta(ControlPrestamos cp) {
         int id, celda;
         String marca, nombre;
         char estado;
         Herramienta h;
      ...
      private static void altaPrestamo(ControlPrestamos cp) {
         int id, celda;
      ...
      private static void altaDevolucion(ControlPrestamos cp) {
         int id, celda;
      ...
      private static void consultaIndividualTrabajador(ControlPrestamos cp) {
         int id, celda;
      ...
      private static void consultaIndividualHerramienta(ControlPrestamos cp) {
         int id, celda;
      ...
      private static void consultaIndividualPrestamo(ControlPrestamos cp) {
         int id, celda, celdaTH;
         if(cp.getContPrestamo() > 0) {
      ...
      private static void consultaGeneralTrabajador(ControlPrestamos cp) {
         if(cp.getContTrabajador() > 0) {
      ...
      private static void consultaGeneralHerramienta(ControlPrestamos cp) {
         if(cp.getContHerramienta() > 0) {
      ...
      private static void reportePrestamosActivos(ControlPrestamos cp) {
         int id, celda, celdaTH;
         if(cp.getContPrestamo() > 0) {
      ...
      private static void reportePrestamosConcluidos(ControlPrestamos cp) {
         int id, celda, celdaTH;
         if(cp.getContPrestamo() > 0) {
